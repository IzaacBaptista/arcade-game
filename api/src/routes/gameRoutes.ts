...
router.post("/vault/rare/buy", GameController.buyRare);
router.get("/shop", GameController.shop);
router.post("/shop/buy", GameController.shopBuy);
router.post("/ai/tips", GameController.aiTips);
